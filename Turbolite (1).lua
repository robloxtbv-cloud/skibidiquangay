...
local v466 = vu32:MakeWindow({
    Title = "tho bay mau Hub",
    SubTitle = "blox fruits",
    SaveFolder = "Redz | redz lib v5.lua"
})

v466:AddMinimizeButton({
    Button = { Image = "rbxassetid://125065621572959", BackgroundTransparency = 0 },
...
v484:AddDiscordInvite({
    Name = "DMT | Giao Lưu",
    Description = "discord tai delta nha ae",
    Logo = "rbxassetid://16274808221",
    Invite = "https://discord.gg/yubpUfNPDe"
})
